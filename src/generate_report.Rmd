...
Let's explore the relationship between chocolate darkness and expert ratings. We would first treat expert ratings as a continuous variable, followed by analysis in which it would also be treated as a categorical variable.
