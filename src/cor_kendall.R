...
# a kendall correlation between Cocoa content and rating of chocolates. This script takes two arguments -
# a path or filename by which to load the data, and another path or filename
# by which to save the csv file.
#
# Usage: Rscript cor_kendall.R ../data/cleaned_coco.csv ../results/cor_kendall.csv
...
main <- function() {
  ...
  coco <- tidy(cor.test(coco$darkness,coco$rating, method="kendall"))
